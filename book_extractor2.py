...
class Book_Extractor():
    ...
    def detect_goodLines(self, linesL):
        goodLines = []
        for line in linesL:
    ...
    def inner_product(self, p1, p2, p3, p4):
    ...
    def calc_cross_point(self, p1, p2, p3, p4):
        ...
        if(abs(s1+s2)>=self.AREA_THRESHOLD):
...
#        for j in range(i+1, len(dists)):
    def run(self):
        ...
        goodLines = self.detect_goodLines(linesL)
